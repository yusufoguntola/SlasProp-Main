...
const Footer =() =>{
    ...
    return(
        <>
            <Box sx={{backgroundColor:'#18784E', color: "white", display: "flex", borderBottom:"1px solid #1C8C5B"}}>
                <Box sx={{display:'flex', flexDirection:"column", py:4, px:10}}>
                    <Box 
                        ...
                        src={sampleImage}
                        />
                    <Box sx={{display:'flex', py:2, justifyContent:"space-between", maxWidth:120}}>
                        <IconButton sx={{backgroundColor:'white', maxHeight:25, maxWidth: 25}}>
                ...
                <Box sx={{py:4, px:10}}>
                    ...
                    <List>
                        <ListItem disablePadding>
                            <ListItemText primaryTypographyProps={{fontSize:'10px', mt:-0.5}}>
                                Home
                            </ListItemText>
                        </ListItem>
                        <ListItem disablePadding>
            ...
            <Box sx={{backgroundColor:'#18784E', color: "white", height:"50px"}}>
                ...
                <Box sx={{pt:2, px:10, display:"flex"}}>
                    <Typography sx={{fontSize:"12px", flexGrow:1}}>
                        2023 <CopyrightIcon sx={{maxHeight:10, maxWidth:10}}/> <span style={{color:"#DF593D"}}>SlasProp </span>  All Rights Reserved
                    </Typography>

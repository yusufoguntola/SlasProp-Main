            ...
            <Container sx={{display:"flex", py:6,backgroundColor:"#F3FAFA",}}>
                <Box sx={{display:"flex", flexDirection:"column"}}>
                    ...
                    <Typography paragraph sx={{pl:4, pr:20, mt:2, fontSize:"14px"}}>
                        Are you ready to embark on a fulfilling career journey? At SlasProp, we believe in fostering
                        talent, creativity, and innovation. Join our dynamic team, where your skills are valued, and
                        your aspirations are supported.
                    </Typography>
                    <Button 
                        sx={{
                        bgcolor: "#26a69a", 

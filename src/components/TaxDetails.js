...
const TaxDetails = (props) => {
    return (
        <Box sx={{display:'flex', flexDirection:'column',border:'2px solid #26a69a', pb:2}}>
            ...
            <Box sx={{display:'flex', mt:1}}>
                ...
                <Box sx={{display:'flex', mx:2.5,flexDirection:'column'}}>
                    ...
                    {
                        props.property.taxDetails.propertyTax.map( propTax => <Typography sx={{color:'grey', fontSize:'10px'}}>
                            {propTax}
                        </Typography>
                ...
                <Box sx={{display:'flex', ml:7,flexDirection:'column'}}>
                    ...
                    {
                        props.property.taxDetails.taxAssessment.map( taxAs => <Typography sx={{color:'grey', fontSize:'10px'}}>

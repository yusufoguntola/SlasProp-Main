    ...
    return (
        <>
            <Container sx={{display:'flex',  mt:4, justifyContent:'space-between'}}>            
                <Box sx={{display:'flex', flexDirection:'column', borderRight:'2px solid lightgray', maxHeight:'80px'}}>
                    ...
                    <Typography sx={{mt:0.5, fontStyle:"italic", color:"#26a69a", fontWeight:'bold', fontSize:'20px'}}>
                ...
                <Box sx={{display:'flex', ml:4, py:1, maxHeight:'80px', justifyContent:'space-between'}}>
                    <Box sx={{display:'flex', flexDirection:'column', py:2, px:4, mr:2, border:'1px solid lightgray'}}>
                    ...
                    <Box sx={{display:'flex', flexDirection:'column', py:2, px:4, border:'1px solid lightgray'}}>
                        <Typography sx={{color:'#26a69a', fontWeight:'bold'}}>
                            {props.property.area}
                        </Typography>
                        <Typography sx={{color:'black'}}>
            ...
            <Container sx={{mt:-2}}>
                <Box sx={{border:'1px solid lightgray', maxWidth:600}}>   
                    <Box sx={{display:'flex', borderBottom:'1px solid lightgray' }}>
                        <Box sx={{display:'flex', flexDirection:'column', borderRight:'1px solid lightgray', px:4,py:2}}>
                    ...
                    <Box sx={{display:'flex', borderBottom:'1px solid lightgray'}}>
                        <Box sx={{display:'flex', flexDirection:'column', borderRight:'1px solid lightgray', px:4,py:2}}>
                            ...
                            <Typography sx={{color:'black', fontWeight:'bold', mr:14.75}}>
                                4786 Sqft
                            </Typography>
                        </Box>
                        <Box sx={{display:'flex', flexDirection:'column', px:4,py:2}}>
            ...
            <Container sx={{mt:2, display:'flex', mb:4}}>
                <Box>
                    ...
                    <Button sx={{   mt:2, 
                            ...
                            onClick={()=>{setIsPropDetails(!isPropDetails)}} 
                            endIcon={isPropDetails?<KeyboardArrowDown/>:<KeyboardArrowUp/>}
                    >
                        Property Details 
                    </Button>
                    <Button sx={{   mt:2, 
                            ...
                            onClick={()=>{setIsConstDetails(!isConstDetails)}} 
                            endIcon={isConstDetails?<KeyboardArrowDown/>:<KeyboardArrowUp/>}
                    >
                ...
                <Box sx={{display:'flex', flexDirection:'column',mt:6, minWidth:300}}>
                    <OwnerDetails property = {props.property}/>
                    
                    <Box sx={{display:'flex', flexDirection:'column',border:'2px solid #26a69a', mt:2, pb:2}}>
                        <Typography sx={{backgroundColor:'#26a69a', color:'white', fontSize:'16px', fontWeight:'bold', py:1.5,px:1}}>
                            Listed By
                        </Typography>
                        <Box sx={{display:'flex', justifyContent:'space-between', px:2}}>
                            <Typography sx={{mt:1,color:'#26a69a', fontSize:'12px', fontWeight:'bold'}}>
                                {props.property.OwnerDetails.initials[0]}
                            </Typography>

                            <Typography sx={{mt:1,color:'gray', fontSize:'12px', fontWeight:'bold'}}>
                                {props.property.OwnerDetails.owner[0]}
                            </Typography>

                            <Typography sx={{mt:1,color:'#26a69a', fontSize:'10px'}}>
                                {props.property.OwnerDetails.totalYears[0]}
                            </Typography>
                        </Box>
                    </Box>

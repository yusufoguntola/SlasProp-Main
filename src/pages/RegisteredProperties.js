...
const RegisteredProperties =() =>{
    ...
    return(
        <Container>
            ...
            <Box sx={{marginLeft:"30%", mt:4, pb:2, display:"flex", flexDirection:'column'}}>
                {
                    properties.map((property) => 
                    <Box sx={{border:"1px solid lightgray", mb:4}}>
                        <Box sx={{display:"flex", pl:6}}>
                            <Typography sx={{borderRight:'1px solid lightgray', px:4,py:2,fontSize:'12px',color:'grey'}}>
                                Property Owner Name
                                <Typography sx={{color:'black', fontWeight:'bold'}}>
                                    {property.name}
                                </Typography>
                            </Typography>
                            <Typography sx={{borderRight:'1px solid lightgray',py:2,px:4,fontSize:'12px',color:'grey'}}>
                                Type Of Land
                                <Typography sx={{color:'black', fontWeight:'bold'}}>
                                    {property.landType}
                                </Typography>
                            ...
                            <Typography sx={{display:'flex', }}>
                                <Typography sx={{px:4,py:2,fontSize:'12px',color:'grey',display:'flex', flexDirection:'column', flexGrow:1}}>
                                    Registration Number
                                    <Typography sx={{color:'black', fontWeight:'bold', margin:'auto'}}>
                                        {property.regNumber}
                                    </Typography>
                                </Typography>
                        ...
                        <Box sx={{display:"flex", border:"1px solid lightgray", pl:6}}>
                            <Typography sx={{borderRight:'1px solid lightgray',py:2,pl:4, pr:5.5,fontSize:'12px',color:'grey'}}>
                                Property Tax ID
                                <Typography sx={{color:'black', fontWeight:'bold'}}>
                                    {property.taxID}
                                </Typography>
                            </Typography>
                            <Typography sx={{borderRight:'1px solid lightgray',py:2, pl:4, pr:7.25,fontSize:'12px',color:'grey'}}>
                                Area Of Land
                                <Typography sx={{color:'black', fontWeight:'bold'}}>
                                    {property.area}
                                </Typography>
                        ...
                        <Box sx={{display:"flex", pl:6}}>
                            <Typography sx={{borderRight:'1px solid lightgray', py:2,pr:13.5,fontSize:'12px',color:'grey'}}>
                                ZIP/ PIN Code
                                <Typography sx={{color:'black', fontWeight:'bold'}}>
                                    {property.zip}
                                </Typography>
            ...
            <Box sx={{marginLeft:"30%",pb:2, display:'flex'}}>
                ...
                {isPressed ? properties.map((property) => <TaxOwnerDetailsCard property={property}/> ): <Box minHeight={140} >
                </Box> }
                {
                    isPressed &&                 
